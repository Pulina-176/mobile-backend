...
const RestaurantDetails = () => {
  ...
  if (!restaurant) {
    return <p className="text-center text-gray-500">No restaurant details available.</p>;
  }
  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-4 ml-16">
        ...
        {/* Special Deals */}
        <div className="mt-6">
          <h3 className="text-base font-semibold leading-7 text-gray-900">Special Deals</h3>
          <div className="flex flex-wrap gap-4">
            {restaurant.specialDeals && restaurant.specialDeals.map((deal, index) => (
              <div
                key={index}
